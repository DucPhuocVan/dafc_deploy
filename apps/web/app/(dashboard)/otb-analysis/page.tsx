...
export default function OTBAnalysisPage() {
  ...
  const getVersionBadge = (versionType: string) => {
    const colors: Record<string, string> = {
      V0_SYSTEM: 'bg-blue-100 text-blue-800',
      V1_USER: 'bg-blue-100 text-blue-800',
      V2_ADJUSTED: 'bg-yellow-100 text-yellow-800',
      V3_REVIEWED: 'bg-yellow-100 text-yellow-800',
      VA_APPROVED: 'bg-green-100 text-green-800',
      VF_FINAL: 'bg-green-100 text-green-800',
